        ...
        <div className="">
          ...
          >
            ...
            <div className="p-4 flex-1">
              ...
              <button
                onClick={() => navigate(`/blog/${vlog?._id}`)}
                className="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-opacity-50 dark:text-gray-400 dark:bg-gray-800"
              >
                Read More
              </button>
            </div>

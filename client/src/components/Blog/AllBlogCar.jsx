...
const AllBlogCard = ({ vlog, key }) => {
  ...
  return (
    <div
      ...
      key={key}
      className="flex bg-white shadow-lg m-4 rounded-lg overflow-hidden"
    >
      {/* Left Side - Image */}
      ...
      <div className="p-4 flex-1">
        {/* Category */}
        <div className="bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full inline-block mb-2">
          {(vlog?.categories && vlog?.categories[0]) || "Category"}
        </div>

        {/* Blog Title and Date */}
        <div className="text-xs flex justify-between text-gray-500 mb-2">
